...
const actionSource = await readFile(new URL("../src/app/actions/presence.ts", import.meta.url), "utf8").catch(() => "")
const componentSource = await readFile(new URL("../src/components/presence/presence-heartbeat.tsx", import.meta.url), "utf8").catch(() => "")
