...
export const getPersonnelColumns = (divisions: Division[], canManage: boolean): ColumnDef<PersonnelData>[] => {
  ...
  return canManage ? [...baseColumns, { id: "actions", header: "Actions", cell: ({ row }) => <PersonnelActions person={row.original} divisions={divisions} /> }] : baseColumns
}
