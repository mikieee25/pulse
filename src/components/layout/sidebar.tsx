...
const navItems: Array<{ href: string; label: string; icon: LucideIcon }> = [
  ...
  { href: "/tutorial", label: "Tutorial", icon: CircleHelp },
];

const linkClassName =
  "flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-slate transition-colors hover:bg-pulse/10 hover:text-pulse focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pulse/40";
